...
A LIDO/XML export of the fishing creel's catalogue record, migrated from a legacy archive (UC-V-3) and minted with a persistent Handle.
#### json
```json
{
...
description: "A `digital-representation` constrained to archival document formats
  \u2014 PDF/A or LIDO/XML \u2014 with\na mandatory persistent identifier, for long-term
  archival reference (D8.2 profile C).\n"
allOf:
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/bblocks-heritage/build/annotated/heritage/archival-document/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/bblocks-heritage/build/annotated/heritage/archival-document/schema.yaml)
...
[context.jsonld](https://ogcincubator.github.io/bblocks-heritage/build/annotated/heritage/archival-document/context.jsonld)

## Sources

* [PDF/A (ISO 19005)](https://www.iso.org/standard/75163.html)
* [LIDO](https://lido-schema.org/)
...
* Path: `_sources/archival-document`
