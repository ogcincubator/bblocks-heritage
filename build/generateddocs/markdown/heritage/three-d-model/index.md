...
A photogrammetry-derived glTF model documenting the Great Gallery ceiling painting in 3D.
#### json
```json
{
...
title: 3D Model
description: 'A `digital-representation` constrained to real-time 3D model formats:
  glTF (binary or JSON),

  Wavefront OBJ, or an OGC 3D Tiles tileset (D8.2 profile B).
...
- type: object
  ...
  properties:
    mediaType:
      ...
      - model/obj
      - application/json
      description: '`model/gltf-binary` (.glb) or `model/gltf+json` (.gltf) for glTF
        2.0, `model/obj` for Wavefront OBJ, or `application/json` for an OGC 3D Tiles
        tileset.'
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/bblocks-heritage/build/annotated/heritage/three-d-model/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/bblocks-heritage/build/annotated/heritage/three-d-model/schema.yaml)
...
[context.jsonld](https://ogcincubator.github.io/bblocks-heritage/build/annotated/heritage/three-d-model/context.jsonld)
